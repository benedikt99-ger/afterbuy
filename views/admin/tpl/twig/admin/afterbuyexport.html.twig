...
<form name="myedit" id="myedit" action="{{ oViewConf.getSelfLink() }}" method="post">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td class="edittext" valign="top" style="padding-top: 10px;">
                <input type="submit" class="edittext" name="save" value="Save"
                       onclick="document.myedit.fnc.value='save'; return true;">
                &nbsp;
                <input type="submit" class="edittext" name="sendTracking" value="Save &amp; send to customer"
